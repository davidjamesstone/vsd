...
app.controller('ApiCtrl', ['$scope', '$state', 'dialog', 'apiPromise',
  function($scope, $state, $dialog, apiPromise) {
    ...
    var homeCtrl = api.addController({ name: 'Home', code: '// require modules \n var path = require(\'path\')' });
    ...
    var userCtrl = api.addController({ name: 'User', code: '' });
    var saveUserHandler = userCtrl.addHandler({ name: 'saveUser', code: 'function(req, res) { req.send("saveUser"); }' });
