  ...
  .directive('uiAce', ['uiAceConfig', function (uiAceConfig) {
    ...
    //acee.setAutoScrollEditorIntoView(true);
      ...
      if (angular.isDefined(opts.showPrintMargin)) {
        acee.renderer.setShowPrintMargin(opts.showPrintMargin);
      }
      ...
      if (angular.isDefined(opts.minLines)) {
        acee.setOption('minLines', opts.minLines);
      }
    ...
    return {
      ...
      link: function (scope, elm, attrs, ngModel) {
        ...
        scope.$watch( attrs.uiAce, function(current, previous) {
          ...
          acee.removeListener('change', onChangeListener);

          // bind new change listener
          onChangeListener = listenerFactory.onChange(opts.onChange);
          acee.on('change', onChangeListener);
